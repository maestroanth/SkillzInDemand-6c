...
var HeroService = (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        return this.http.get(this.heroesUrl)
            ...
            .then(function (response) { return response.json().data; }) //extract data within response (notice the .json file)
    ...
    HeroService.prototype.getHero = function (id) {
        var url = this.heroesUrl + "/" + id; //gets hero by ID instead of searching through whole array like before

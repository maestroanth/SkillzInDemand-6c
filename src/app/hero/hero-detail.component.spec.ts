...
function heroModuleSetup() {
  ...
  describe('when navigate with no hero id', () => {//when trying to navigate to a null id, it should display hero creation page
  ...
  describe('when navigate to non-existant hero id', () => {//this is to navigate to a bad id
    beforeEach( async(() => {
...
class Page {//this is to help tame the madness of all the testing hero-detail.component.html needs to fully exercise the component
  gotoSpy:      jasmine.Spy;
  navSpy:       jasmine.Spy;
